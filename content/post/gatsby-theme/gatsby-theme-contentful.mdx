---
slug: /blog/gatsby-theme-contentful
...
date: 2020-05-23
categories:
  ['react', 'node', 'gatsby', 'theme', 'contentful', 'tailwindCSS', 'blog']
published: true
---
...
Authentication works out of the box if you provide the credentials in the `.env.development` and `.env.production` files
...
Create a Contentful account to add the Schema [Contentful](https://www.contentful.com/sign-up/)
...
1.  **Create a Site using the Theme**
...
2.  **Open the source code and start editing!**
    ...
    - Open the `theme-contentful-quick-start` directory in your code editor of choice

## Additional configuration

In addition to the theme options, there are a handful of items you must modify
